...
rad0=0
while(ballface.getCap() & ballface.getifkeep()):
    ballface.getball()
    xCenter = ballface.getxCenter()
    yCenter = ballface.getyCenter()
    print("(", xCenter, ", ", yCenter, ")")
    # xSocket.send(str(xCenter).encode('utf-8'))
    # ySocket.send(str(yCenter).encode('utf-8'))

    # ballface.getball()
    xCenter = ballface.getballX()
    yCenter = ballface.getballY()
    ballrad = ballface.getradius()
